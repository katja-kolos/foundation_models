...
def prepare_model(model_name, local_adapter_path, checkpoint, tensor_parallel_size, cpu_offload_gb, max_model_len):
...
def main():
    ...
    parser.add_argument(
        "--local_path",
        type=str,
        default="qwen_qwen2-vl-2b-instruct_golden",
    ...
    #"qwen_qwen2-vl-2b-instruct_golden/checkpoint-9500"
    llm = prepare_model(args.model_name, args.local_path, args.checkpoint, tensor_parallel_size=args.ngpus, cpu_offload_gb=args.cpuRAM, max_model_len=args.maxtokens)
