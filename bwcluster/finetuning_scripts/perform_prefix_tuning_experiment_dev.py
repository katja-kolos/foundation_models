...
def train(model, tokenizer, processor, optimizer, dataloader_train, dataloader_val, preprocess_func):
    ...
    for epoch in tqdm(range(NUM_EPOCHS_FT)):
        ...
        # show sample output at this epoch
        logging.info(f"Sample at the start of epoch {epoch}")
        prompts, texts, images, y = dataloader_train[0]
        ...
        with torch.no_grad(): #optimizer.zero_grad()
            logging.info("output_text after forward pass:")
